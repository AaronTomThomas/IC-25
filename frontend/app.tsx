...
import BoroughDeploymentView from "./components/BoroughDeploymentView";
...
const policeStations = [
  ...
  {
    name: "Ilford Police Station",
    postcode: "IG1 1GT",
    latitude: 51.56029,
    longitude: 0.08041,
    officersAvailable: 15,
  },
  {
    name: "Barking Learning Centre",
    postcode: "IG11 7NB",
    latitude: 51.53632,
    longitude: 0.07979,
    officersAvailable: 19,
  },
  {
    name: "Romford Police Station",
    postcode: "RM1 3BJ",
    latitude: 51.58203,
    longitude: 0.18618,
    officersAvailable: 11,
  ...
  {
    name: "Borehamwood Police Station (Hertfordshire Constabulary)",
    postcode: "WD6 1WA",
    latitude: 51.65961,
    longitude: -0.26848,
    officersAvailable: 1,
  ...
  {
    name: "Bexleyheath Police Station",
    postcode: "DA7 4QS",
    latitude: 51.45705,
    longitude: 0.14911,
    officersAvailable: 1,
  ...
  {
    name: "Dartford Contact Point (Kent Police)",
    postcode: "DA1 1DR",
    latitude: 51.44666,
    longitude: 0.21926,
    officersAvailable: 4,
  ...
  {
    name: "Swanley Police Station (Kent Police)",
    postcode: "BR8 7AJ",
    latitude: 51.39804,
    longitude: 0.17072,
    officersAvailable: 3,
  ...
  {
    name: "Wembley Police Station (British Transport Police)",
    postcode: "HA9 9AA",
    latitude: 51.56332,
    longitude: -0.27924,
    officersAvailable: 9,
  ...
  {
    name: "Kentish Town Police Station",
    postcode: "NW5 3AE",
    latitude: 51.54968,
    longitude: -0.14202,
    officersAvailable: 5,
  ...
  {
    name: "Bromley Police Station",
    postcode: "BR1 1ER",
    latitude: 51.39937,
    longitude: 0.01788,
    officersAvailable: 16,
  },
  {
    name: "Lewisham Police Station",
    postcode: "SE13 5JZ",
    latitude: 51.46327,
    longitude: -0.00978,
    officersAvailable: 1,
  ...
  {
    name: "Croydon Police Station (British Transport Police)",
    postcode: "CR0 6SR",
    latitude: 51.37564,
    longitude: -0.09041,
    officersAvailable: 3,
  ...
  {
    name: "Euston Police Station (British Transport Police)",
    postcode: "NW1 2DU",
    latitude: 51.52866,
    longitude: -0.1333,
    officersAvailable: 2,
  ...
  {
    name: "Paddington Police Station (British Transport Police)",
    postcode: "W2 1FT",
    latitude: 51.51751,
    longitude: -0.17741,
    officersAvailable: 4,
  ...
  {
    name: "Hammersmith Police Station",
    postcode: "W6 7NX",
    latitude: 51.49463,
    longitude: -0.22431,
    officersAvailable: 1,
  ...
  {
    name: "Cheshunt Police Station (Hertfordshire Constabulary)",
    postcode: "EN8 9BD",
    latitude: 51.70292,
    longitude: -0.03489,
    officersAvailable: 19,
  ...
  {
    name: "West Ham Police Station (British Transport Police)",
    postcode: "E15 3AT",
    latitude: 51.52948,
    longitude: 0.00539,
    officersAvailable: 0,
  ...
  {
    name: "Bethnal Green Police Station",
    postcode: "E2 9NZ",
    latitude: 51.52812,
    longitude: -0.05371,
    officersAvailable: 7,
  ...
  {
    name: "Stoke Newington Police Station",
    postcode: "N16 8DS",
    latitude: 51.55785,
    longitude: -0.07482,
    officersAvailable: 15,
  ...
  {
    name: "Bishopsgate (City of London Police)",
    postcode: "EC2M 4NP",
    latitude: 51.51773,
    longitude: -0.07999,
    officersAvailable: 15,
  ...
  {
    name: "Oxhey Police Station (Hertfordshire Constabulary)",
    postcode: "WD19 7SD",
    latitude: 51.6259,
    longitude: -0.38928,
    officersAvailable: 16,
  ...
  {
    name: "Barkingside Police Station",
    postcode: "IG6 1QB",
    latitude: 51.58824,
    longitude: 0.08046,
    officersAvailable: 18,
  },
  {
    name: "Hayes Police Station",
    postcode: "UB4 8HU",
    latitude: 51.52519,
    longitude: -0.43507,
  ...
  {
    name: "Twickenham Police Station",
    postcode: "TW1 3SY",
    latitude: 51.44788,
    longitude: -0.32938,
    officersAvailable: 3,
  ...
  {
    name: "Ebbsfleet Police Station (British Transport Police)",
    postcode: "DA10 1EB",
    latitude: 51.44302,
    longitude: 0.32095,
    officersAvailable: 16,
  ...
  {
    name: "Elmbridge Civic Centre (Surrey Police)",
    postcode: "KT10 9SD",
    latitude: 51.36992,
    longitude: -0.36191,
    officersAvailable: 5,
  ...
  {
    name: "Spring House (British Transport Police)",
    postcode: "N7 8JL",
    latitude: 51.54869,
    longitude: -0.10703,
  ...
  {
    name: "London Bridge (British Transport Police)",
    postcode: "SE1 9SG",
    latitude: 51.50496,
    longitude: -0.08765,
    officersAvailable: 2,
  ...
  {
    name: "Epsom Town Hall (Surrey Police)",
    postcode: "KT18 5BY",
    latitude: 51.33279,
    longitude: -0.26502,
    officersAvailable: 4,
  ...
  {
    name: "Forest Gate Police Station",
    postcode: "E7 8BS",
    latitude: 51.54677,
    longitude: 0.03139,
    officersAvailable: 6,
  ...
  {
    name: "Lavender Hill Police Station",
    postcode: "SW11 1JX",
    latitude: 51.46468,
    longitude: -0.1622,
    officersAvailable: 10,
  ...
  {
    name: "Kensington Police Station",
    postcode: "W8 6EQ",
    latitude: 51.49701,
    longitude: -0.19756,
    officersAvailable: 2,
...
export default function App({
    ...
    fetch("./lad.json")
      ...
      .then((data) => {
        ...
        boroughNames.forEach((name) => {
          boroughColorMapping[name] = getRandomCoolColor();
        });
  ...
  // Compute the deployment of officers per borough based on the static crime data
  const deployments = useMemo(() => {
    if (!data) return {};
    const deploymentsMap: Record<string, number> = {};

    Object.keys(boroughsMapping).forEach((borough) => {
      const bounds = boroughsMapping[borough];
      // Count the number of crimes in the borough at the selected time
      const crimeCount = data.filter((d) => {
        const [lng, lat, time] = d;
        return (
          lng >= bounds.west &&
          lng <= bounds.east &&
          lat >= bounds.south &&
          lat <= bounds.north &&
          Math.abs(time - selectedTime) <= timeWindow
        );
      }).length;

      // A simple formula: assign one officer for every 3 crimes (adjust as needed)
      const maxOfficers =
        Math.max(
          ...policeStations.map((station) => station.officersAvailable)
        ) * 3;
      deploymentsMap[borough] =
        Math.min(Math.ceil(crimeCount / 3), maxOfficers) + 2;
    });

    return deploymentsMap;
  }, [data, boroughsMapping, selectedTime]);
  ...
  const suggestForceDeployment = async (
    ...
    let minDistance = getDistanceKm(lat, lng, nearestStation.latitude, nearestStation.longitude);

    for (const station of policeStations) {
      const distance = getDistanceKm(lat, lng, station.latitude, station.longitude);
      console.log(station)
    ...
    console.log("nearest: " + nearestStation.name);
    ...
    const criticalSeverityCount = nearbyPings.filter(
      (ping) => ping.severity === "Critical"
    ).length;
    const highSeverityCount = nearbyPings.filter(
      (ping) => ping.severity === "High"
    ).length;
    const mediumSeverityCount = nearbyPings.filter(
      (ping) => ping.severity === "Medium"
    ).length;
    const lowSeverityCount = nearbyPings.filter(
      (ping) => ping.severity === "Low"
    ).length;

    const prompt = `Given a crime ping of type "${crime_ping}" with severity "${crime_severity}" at coordinates (${lat}, ${lng}) at time (${new Date().toISOString()}), and considering that the nearest police station is "${
      nearestStation.name
    }" with ${officersAvailable} officers available, how many officers should be dispatched from this station? 
    ...
    Please specify the **exact number of officers to dispatch** and confirm that they will be sent from "${
      nearestStation.name
    }".`;
  ...
  const [crime, setCrime] = useState<{ type: string; severity: string } | null>(
    null
  );
  ...
  const handleAddPing = () => {
    ...
    const newPing = {
      ...
      lat,
      lng,
      crime: randomCrimeType,
      severity: crimeSeverityMapping[randomCrimeType],
    };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
      ...
      {/* New view showing borough deployments */}
