...
import IconManager from "@deck.gl/layers/src/icon-layer/icon-manager.js";
...
import type { UnpackedIcon, IconMapping, LoadIconErrorContext } from "@deck.gl/layers/src/icon-layer/icon-manager.js";
